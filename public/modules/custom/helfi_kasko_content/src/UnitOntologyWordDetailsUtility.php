...
class UnitOntologyWordDetailsUtility {
  ...
  public function findOntologyWordKeysLabelsbyId($id): array|null {
    ...
    $ontologyDetailsIdRangeToKeysLabels = [
      ...
      '15-26' => [
        'key' => '#a1',
        'label' => $this->t('Language starting in 1st grade (A1)', [], $context),
      ],
      '27-38' => [
        'key' => '#a2',
        'label' => $this->t('Language starting in 3rd grade (A2)', [], $context),
      ],
      '101-112' => [
        'key' => '#b1',
        'label' => $this->t('Language starting in 6th grade (B1)', [], $context),
      ],
      '113-124' => [
        'key' => '#b2',
        'label' => $this->t('Language starting in 8th grade (B2)', [], $context),
      ],
      '293-297' => [
